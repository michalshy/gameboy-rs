...
use crate::{cpu::{decoder::OpcodeEntry, interrupts::Interrupts}, debug::disasm::disassemble, mmu::Mmu};
...
impl Cpu {
    pub fn new() -> Self {
        Self { registers: Registers::new(), int: Interrupts::new(), history: Vec::new() }
    }
